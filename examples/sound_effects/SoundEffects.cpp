...
int main()
{
    ...
    sf::Text playbackDevice(font, "Current playback device: " + (playbackDeviceName ? *playbackDeviceName : "None"), 20);
                ...
                switch (keyPressed->code)
                {
                    ...
                    case sf::Keyboard::Key::F1:
                    {
                        ...
                        if (next)
                        {
                            ...
                            playbackDevice.setString(
                                "Current playback device: " + (playbackDeviceName ? *playbackDeviceName : "None"));
                        }
